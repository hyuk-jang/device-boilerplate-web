 ...
 */ var SVG = (function() {
  ...
  var nativeWeakMap =
    typeof WeakMap === 'function' && /native code/.test(functionToString.call(WeakMap));
  ...
  var redefine = createCommonjsModule(function(module) {
    ...
    (module.exports = function(O, key, value, options) {
      ...
      return (
        (typeof this == 'function' && getInternalState(this).source) || functionToString.call(this)
      );
    });
  });
  ...
  var wellKnownSymbol = function(name) {
    return (
      store$2[name] ||
      (store$2[name] =
        (nativeSymbol && Symbol$1[name]) || (nativeSymbol ? Symbol$1 : uid)('Symbol.' + name))
    );
  };
  ...
  function registerMethods(name, m) {
    if (Array.isArray(name)) {
      ...
      try {
        for (
          var _iterator = name[Symbol.iterator](), _step;
  ...
  function css(style, val) {
    ...
    if (arguments.length < 2) {
      ...
      if (Array.isArray(style)) {
        ...
        try {
          for (
            var _iterator = style[Symbol.iterator](), _step;
            !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
            _iteratorNormalCompletion = true
          ) {
      ...
      if (_typeof(style) === 'object') {
        for (var _name in style) {
          ...
          this.node.style[camelCase(_name)] =
            style[_name] == null || isBlank.test(style[_name]) ? '' : style[_name];
        }
      }
          ...
          },
          {
            ...
            value: function rgb() {
              if (this.space === 'rgb') {
                ...
                var bU = x * 0.0557 + y * -0.204 + z * 1.057; // Convert the values to true rgb values
        ...
        [
          {
            ...
            value: function random() {
              var mode =
                arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'vibrant';
            ...
            value: function init(source) {
              ...
              source =
                source instanceof Element
                  ...
                  : _typeof(source) === 'object' && Matrix.isMatrixLike(source)
                  ? source
  ...
  List.extend = function(methods) {
    methods = methods.reduce(function(obj, name) {
      ...
      obj[name] = function() {
        for (
          var _len2 = arguments.length, attrs = new Array(_len2), _key2 = 0;
          _key2 < _len2;
          _key2++
        ) {
      ...
      _createClass(Element, [
        ...
        },
        {
          ...
          value: function parents() {
            var until =
              arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : globals.document;
  ...
  registerMethods(['Element', 'Runner'], {
    ...
    flip: function flip(direction, around) {
      var directionString =
        typeof direction === 'string' ? direction : isFinite(direction) ? 'both' : 'both';
      var origin =
        direction === 'both' && isFinite(around)
          ? [around, around]
          : direction === 'x'
          ? [around, 0]
          : direction === 'y'
  ...
  _export(
    { target: 'Array', proto: true, forced: String(test$1) === String(test$1.reverse()) },
    {
  ...
  // https://tc39.github.io/ecma262/#sec-object.getownpropertydescriptor
  _export(
    { target: 'Object', stat: true, forced: FORCED$3, sham: !descriptors },
    {
    ...
    (function(_Shape) {
      ...
      function Circle(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Circle).call(this, nodeOrNew('circle', node), node),
        );
      }
  ...
  var Defs =
    ...
    (function(_Container) {
      ...
      function Defs(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Defs).call(this, nodeOrNew('defs', node), node),
        );
      }
  ...
  var Ellipse =
    ...
    (function(_Shape) {
      ...
      function Ellipse(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Ellipse).call(this, nodeOrNew('ellipse', node), node),
        );
      }
  ...
  var Stop =
    ...
    (function(_Element) {
      ...
      function Stop(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Stop).call(this, nodeOrNew('stop', node), node),
        );
      } // add color stops
  ...
  var Pattern =
    ...
    (function(_Container) {
      ...
      function Pattern(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Pattern).call(this, nodeOrNew('pattern', node), node),
        );
      } // Return the fill id
  ...
  var Image =
    ...
    (function(_Shape) {
      ...
      function Image(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Image).call(this, nodeOrNew('image', node), node),
        );
      } // (re)load image
  ...
  var Line =
    ...
    (function(_Shape) {
      ...
      function Line(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Line).call(this, nodeOrNew('line', node), node),
        );
      } // Get array
  ...
  var Marker =
    ...
    (function(_Container) {
      ...
      function Marker(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Marker).call(this, nodeOrNew('marker', node), node),
        );
      } // Set width of element
  ...
  registerMethods({
    ...
    marker: {
      ...
      marker: function marker(_marker, width, height, block) {
        ...
        _marker =
          arguments[1] instanceof Marker ? arguments[1] : this.defs().marker(width, height, block);
    ...
    bezier: function bezier(x1, y1, x2, y2) {
      ...
      return function(t) {
        if (t < 0) {
          ...
          return (
            3 * t * Math.pow(1 - t, 2) * y1 + 3 * Math.pow(t, 2) * (1 - t) * y2 + Math.pow(t, 3)
          );
        }
      };
    },
  ...
  var Path =
    ...
    (function(_Shape) {
      ...
      function Path(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Path).call(this, nodeOrNew('path', node), node),
        );
      } // Get array
  ...
  var Polygon =
    ...
    (function(_Shape) {
      ...
      function Polygon(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Polygon).call(this, nodeOrNew('polygon', node), node),
        );
      }
  ...
  var Polyline =
    ...
    (function(_Shape) {
      ...
      function Polyline(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Polyline).call(this, nodeOrNew('polyline', node), node),
        );
      }
  ...
  var Rect =
    ...
    (function(_Shape) {
      ...
      function Rect(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Rect).call(this, nodeOrNew('rect', node), node),
        );
      }
  ...
  var Timeline =
    ...
    (function(_EventTarget) {
      ...
      function Timeline() {
        ...
        var timeSource =
          arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultSource;
	    ...
	    */
          ...
          },
          {
	        ...
	        */
                ...
                var endTime = t * (w + d) - w;
                position =
                  x <= 0 ? Math.round(f(1e-5)) : x < endTime ? f(x) : Math.round(f(endTime - 1e-5));
                return position;
  ...
  var FakeRunner =
    ...
    (function() {
      function FakeRunner() {
        var transforms =
          arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Matrix();
    ...
    (function(_Container) {
      ...
      function Svg(node) {
        ...
        _this = _possibleConstructorReturn(
          this,
          _getPrototypeOf(Svg).call(this, nodeOrNew('svg', node), node),
        );
  ...
  var _Symbol =
    ...
    (function(_Container) {
      ...
      function _Symbol(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(_Symbol).call(this, nodeOrNew('symbol', node), node),
        );
      }
  ...
  var Text =
    ...
    (function(_Shape) {
      ...
      function Text(node) {
        ...
        _this = _possibleConstructorReturn(
          this,
          _getPrototypeOf(Text).call(this, nodeOrNew('text', node), node),
        );
      ...
      _createClass(Text, [
        {
          ...
          value: function x(_x) {
            var box =
              arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.bbox();
        ...
        },
        {
          ...
          value: function move(x, y) {
            var box =
              arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.bbox();
  ...
  var Tspan =
    ...
    (function(_Text) {
      ...
      function Tspan(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Tspan).call(this, nodeOrNew('tspan', node), node),
        );
      } // Set text content
  ...
  var ClipPath =
    ...
    (function(_Container) {
      ...
      function ClipPath(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(ClipPath).call(this, nodeOrNew('clipPath', node), node),
        );
  ...
  var ForeignObject =
    ...
    (function(_Element) {
      ...
      function ForeignObject(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(ForeignObject).call(this, nodeOrNew('foreignObject', node), node),
        );
      }
  ...
  var G =
    ...
    (function(_Container) {
      ...
      function G(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(G).call(this, nodeOrNew('g', node), node),
        );
      }
  ...
  var A =
    ...
    (function(_Container) {
      ...
      function A(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(A).call(this, nodeOrNew('a', node), node),
        );
      } // Link url
  ...
  var Mask =
    ...
    (function(_Container) {
      ...
      function Mask(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Mask).call(this, nodeOrNew('mask', node), node),
        );
  ...
  var Style =
    ...
    (function(_Element) {
      ...
      function Style(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Style).call(this, nodeOrNew('style', node), node),
        );
      }
  ...
  var TextPath =
    ...
    (function(_Text) {
      ...
      function TextPath(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(TextPath).call(this, nodeOrNew('textPath', node), node),
        );
  ...
  var Use =
    ...
    (function(_Shape) {
      ...
      function Use(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Use).call(this, nodeOrNew('use', node), node),
        );
