...
(function(c) {
  ...
  q(c, 'mixins/ajax.js', [c['parts/Globals.js'], c['parts/Utilities.js']], function(b, a) {
    ...
    b.ajax = function(a) {
      var h = b.merge(
        !0,
        { url: !1, type: 'get', dataType: 'json', success: !1, error: !1, data: !1, headers: {} },
        a,
      );
      a = {
  ...
  q(c, 'mixins/download-url.js', [c['parts/Globals.js']], function(b) {
    ...
    b.downloadURL = function(e, h) {
      ...
      if ('string' === typeof e || e instanceof String || !c.msSaveOrOpenBlob) {
        ...
        if ('undefined' !== typeof p.download)
          (p.href = e), (p.download = h), q.body.appendChild(p), p.click(), q.body.removeChild(p);
        else
          try {
  ...
  q(c, 'modules/export-data.src.js', [c['parts/Globals.js'], c['parts/Utilities.js']], function(
    b,
    a,
  ) {
    function c(b, a) {
      ...
      try {
        ...
        if (!w) return l.createObjectURL(new n.Blob(['\ufeff' + b], { type: a }));
      } catch (G) {}
    }
    var q = a.defined,
      h = a.extend,
    ...
    b.setOptions({
      ...
      lang: {
        ...
        downloadXLS: '엑셀 다운로드',
        openInCloud: 'Highcharts 클라우드 열기 ',
        viewData: '데이터 테이블 보기',
      },
    });
    ...
    b.Chart.prototype.setUpKeyToAxis = function() {
      d.arearange && (d.arearange.prototype.keyToAxis = { low: 'y', high: 'y' });
      d.gantt && (d.gantt.prototype.keyToAxis = { start: 'x', end: 'x' });
    };
          ...
          return k
            ? k instanceof b.Axis
              ? (k.options.title && k.options.title.text) ||
                (k.isDatetimeAxis ? 'DateTime' : 'Category')
              : a
              ? { columnTitle: 1 < g ? c : k.name, topLevelColumnTitle: k.name }
              : k.name + (1 < g ? ' (' + c + ')' : '')
            : 'Category';
        },
        D = function(a, c, g) {
        ...
        if (!1 !== k.options.includeInDataExport && !k.options.isInternal && !1 !== k.visible) {
          ...
          for (m = 0; m < r; )
            (y = z(k, t[m], t.length)),
              ...
              a && p.push(y.topLevelColumnTitle || y),
              m++;
          var q = {
            chart: k.chart,
          ...
          k.options.data.forEach(function(a, b) {
            ...
            for (d[a].xValues[f] = g.x; m < r; )
              (b = t[m]),
                ...
                (d[a][u + m] = e(
                  B.categoryMap[b][l],
                  B.dateTimeValueAxisMap[b] ? h.dateFormat(w.dateFormat, l) : null,
                  l,
                )),
                m++;
          });
          ...
          x &&
            ...
            (x.isDatetimeAxis
              ? (a.x instanceof Date && (a.x = a.x.getTime()),
                (b = h.dateFormat(w.dateFormat, a.x)))
              : (b = x.categories ? e(x.names[a.x], x.categories[a.x], a.x) : a.x));
          a.splice(v, 0, b);
        });
      }
      r = r.concat(f);
      C(this, 'exportData', { dataRows: r });
      return r;
    };
    b.Chart.prototype.getCSV = function(a) {
      ...
      c.forEach(function(a, d) {
        for (var e, m = a.length; m--; )
          (e = a[m]),
            'string' === typeof e && (e = '"' + e + '"'),
            'number' === typeof e && '.' !== l && (e = e.toString().replace('.', l)),
            (a[m] = e);
        b += a.join(h);
        d < c.length - 1 && (b += f);
      });
    ...
    b.Chart.prototype.getTable = function(a) {
      ...
      var f = 0,
        ...
        n = function(a, b, c, h) {
          ...
          b = 'text' + (b ? ' ' + b : '');
          'number' === typeof g
            ? ((g = g.toString()), ',' === d && (g = g.replace('.', d)), (b = 'number'))
            : h || (b = 'empty');
      ...
      b += (function(a, b, e) {
        ...
        if (b) {
          ...
          for (e = b.length; f < e; ++f)
            'undefined' !== typeof b[f] && (d += n('th', null, 'scope="col"', b[f]));
          d += '</tr>';
        }
        return d + '</thead>';
    ...
    b.Chart.prototype.downloadXLS = function() {
      ...
      A(
        c(a, 'application/vnd.ms-excel') ||
          'data:application/vnd.ms-excel;base64,' + n.btoa(unescape(encodeURIComponent(a))),
        this.getFilename() + '.xls',
      );
    };
    b.Chart.prototype.viewData = function() {
      this.dataTableDiv ||
        ((this.dataTableDiv = p.createElement('div')),
