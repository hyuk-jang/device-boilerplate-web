...
function searchReport() {
  ...
  var queryString = 'searchType='
    .concat(searchType, '&searchInterval=')
    .concat(searchInterval, '&strStartDateInputValue=')
    .concat(strStartDateInputValue, '&strEndDateInputValue=')
    .concat(strEndDateInputValue);
  $('#loader').removeClass('hidden');
