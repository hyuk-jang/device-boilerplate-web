...
function writeDateText(domElement) {
  ...
  domElement.innerHTML = "".concat(today.getFullYear(), ".").concat(today.getMonth() + 1, ".").concat(today.getDate(), "(").concat(week[today.getDay()], ")"); // domElement.innerHTML = today.getFullYear() + "." + (today.getMonth() + 1) + "." + today.getDate() + "(" + week[today.getDay()] + ")";
  // $(`#${domId}`).html(
