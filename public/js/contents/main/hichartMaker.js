      ...
      series: [
        {
          ...
          dataLabels: {
            format: '<div style="text-align:center"><span style="font-size:25px;color:'
              ...
              .concat(series.tooltip.valueSuffix, "</span></div>")
          },
          tooltip: {
...
function makeGaugeChart2(powerGenerationInfo, domId) {
  ...
  var percentageKw = _.round(
    _.multiply(_.divide(currKw, currKwYaxisMax), 100),
    2
  );
    ...
    series: [
      {
        ...
        dataLabels: {
          format: '<div style="text-align:center"><span style="font-size:15px;color:'.concat(
...
function makeLineChart(chartInfo) {
  ...
  if (chartInfo.series.length) {
      ...
      yAxis: [
        {
          ...
          labels: {
            ...
            x: 3,
            y: 16,
            format: "{value:.,0f}".concat(
              _.get(chartInfo, "yAxis[0].dataUnit", "")
            )
          },
        ...
        },
        {
          ...
          labels: {
            ...
            y: 16,
            format: "{value:.,0f}".concat(
              _.get(chartInfo, "yAxis[1].dataUnit", "")
            )
          },
          showFirstLabel: false
        }
    ...
    if (_.isNumber(_.get(chartInfo, "plotSeries.pointStart"))) {
      _.assign(
        lineChartInfo.plotOptions.spline,
        _.get(chartInfo, "plotSeries")
      );
    }

    Highcharts.chart(chartInfo.domId, lineChartInfo);
  } else {
    $("#".concat(chartInfo.domId)).html(
      "<h2>".concat(
        chartInfo.title,
        "</h2><h3>\uB0B4\uC5ED\uC774 \uC874\uC7AC\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.</h3>"
      )
    );
  }
}
