      ...
      svgModelResourceList: [
        {
          ...
          type: 'pattern',
          elementDrawInfo: { width: 240, height: 150, color: '#3e4379' },
        },
        {
          id: 'salternModuleBlock_B',
          type: 'pattern',
          elementDrawInfo: { width: 300, height: 300, color: '#3e4379' },
        },
        {
          id: 'salternNomalBlock_A',
          type: 'rect',
          elementDrawInfo: { width: 240, height: 130, color: '#86623b' },
        },
        {
          id: 'salternNomalBlock_B',
          type: 'rect',
          elementDrawInfo: { width: 260, height: 180, color: '#86623b' },
        },
        {
          id: 'earth',
          type: 'pattern',
          elementDrawInfo: { width: 240, height: 120, color: '#4c7093' },
        },
        {
          id: 'salternCrystalBlock',
          type: 'rect',
          elementDrawInfo: { width: 260, height: 180, color: '#4f351a' },
        },
        {
          id: 'brineWarehouse',
          type: 'rect',
          elementDrawInfo: { width: 170, height: 150, color: '#5b666c' },
        },
        {
          id: 'waterDoor',
          type: 'rect',
          elementDrawInfo: { width: 55, height: 55, color: ['#d7dcee', '#2858f9', '#dc1d1f'] },
        },
        {
          id: 'gateValve',
          type: 'rect',
        ...
        { id: 'sea', type: 'rect', elementDrawInfo: { width: 170, height: 120, color: '#0f587c' } },
        {
          id: 'valve',
          type: 'polygon',
          elementDrawInfo: { width: 30, height: 30, color: ['#d5e5e2', '#11d8ae', '#dc1d1f'] },
        },
        ...
        { id: 'waterWay', type: 'line', elementDrawInfo: { width: 55, color: '#82acc1' } },
        {
          id: 'reservoir',
          type: 'rect',
          elementDrawInfo: { width: 550, height: 120, color: '#3d4448' },
        },
        {
          id: 'pump',
          type: 'circle',
        ...
        },
        {
          id: 'waterLevel',
          type: 'rect',
          elementDrawInfo: { width: 50, height: 30, color: '#f0f0f0' },
        },
        {
      ...
      svgPlaceList: [
        {
          ...
          defList: [
            ...
            { id: 'SEB_2', name: '증발지_2', resourceId: 'salternNomalBlock_B', point: [635, 340] },
            { id: 'SEB_3', name: '증발지_3', resourceId: 'salternNomalBlock_B', point: [635, 532] },
            { id: 'SEB_4', name: '증발지_4', resourceId: 'salternNomalBlock_B', point: [635, 727] },
            { id: 'SCB', name: '결정지', resourceId: 'salternCrystalBlock', point: [635, 920] },
          ],
        },
        {
          placeClassId: 'earth',
          defList: [
            { id: 'EA_일반', name: '육상_일반', resourceId: 'earth', point: [0, 855] },
            { id: 'EA_G2G', name: '육상_G2G', resourceId: 'earth', point: [0, 980] },
          ],
        },
        {
          placeClassId: 'brineWarehouse',
          defList: [
            { id: 'BW_1', name: '해주_1', resourceId: 'brineWarehouse', point: [600, 130] },
            { id: 'BW_2', name: '해주_2', resourceId: 'brineWarehouse', point: [790, 130] },
            { id: 'BW_3', name: '해주_3', resourceId: 'brineWarehouse', point: [980, 130] },
          ],
        },
        {
          placeClassId: 'reservoir',
          defList: [{ id: 'RV', name: '저수조', resourceId: 'reservoir', point: [600, 3] }],
        },
        {
          placeClassId: 'sea',
          defList: [{ id: 'SEA', name: '바다', resourceId: 'sea', point: [1030, 980] }],
        },
        {
          ...
          defList: [
            ...
            { id: 'WW_003', name: '수로_3', resourceId: 'waterWay', point: [928, 1100, 928, 340] },
            {
              id: 'WW_004',
              name: '수로_4',
              resourceId: 'waterWay',
        ...
        },
        {
          ...
          defList: [
            { id: 'PL_001', name: '파이프_1', resourceId: 'pipeLine', point: [1150, 24, 1550, 24] },
            {
              id: 'PL_002',
              name: '파이프_2',
              resourceId: 'pipeLine',
            ...
            { id: 'PL_003', name: '파이프_3', resourceId: 'pipeLine', point: [300, 35, 600, 35] },
            { id: 'PL_004', name: '파이프_4', resourceId: 'pipeLine', point: [300, 160, 600, 160] },
            { id: 'PL_005', name: '파이프_5', resourceId: 'pipeLine', point: [300, 150, 300, 35] },
            { id: 'PL_006', name: '파이프_6', resourceId: 'pipeLine', point: [300, 550, 300, 150] },
            { id: 'PL_007', name: '파이프_7', resourceId: 'pipeLine', point: [300, 550, 365, 550] },
            { id: 'PL_008', name: '파이프_8', resourceId: 'pipeLine', point: [365, 550, 365, 530] },
            { id: 'PL_009', name: '파이프_9', resourceId: 'pipeLine', point: [365, 570, 365, 550] },
            {
              id: 'PL_010',
              name: '파이프_10',
              resourceId: 'pipeLine',
      ...
      svgNodeList: [
        ...
        },
        {
          ...
          defList: [
            ...
            { id: 'P_002', name: '펌프_002', placeId: 'RV', resourceId: 'pump', point: [600, 3] },
            { id: 'P_006', name: '펌프_006', placeId: 'RV', resourceId: 'pump', point: [1100, 73] },
            {
              id: 'P_001',
              name: '펌프_001',
              placeId: 'SEA',
